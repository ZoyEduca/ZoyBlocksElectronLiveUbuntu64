...
(() => {
    ...
    const matematica = () => {
        ...
        Blockly.JavaScript.forBlock['math_arithmetic'] = function(block) {
            ...
            if (operator === 'POWER') {
                const argument0 = Blockly.JavaScript.valueToCode(block, 'A', Blockly.JavaScript.ORDER_COMMA);
                const argument1 = Blockly.JavaScript.valueToCode(block, 'B', Blockly.JavaScript.ORDER_COMMA);
        ...
        // Para o teste do bloco 'repita', os blocos 'math_number' e 'math_arithmetic' já são suficientes.
